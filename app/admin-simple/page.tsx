// app/admin-simple/page.tsx - Version simplifiée pour diagnostic
import { redirect } from 'next/navigation';
import { supabaseServer } from '@/lib/supabase/server';

export default async function AdminSimplePage() {
  try {
    console.log('🔍 Admin Simple - Starting...');
    ...
    return (
      <div className="p-8">
        <h1 className="text-2xl font-bold text-green-500 mb-4">Admin Simple - Success!</h1>
        <div className="space-y-4">
          ...
          <div>
            ...
            <p>This page works! The issue is likely in the organization resolution logic.</p>
            <a 
              href="/admin" 
    ...
    console.error('🔍 Admin Simple - Unexpected error:', error);
    return (
      <div className="p-8">
