      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-center px-6 py-16">
          ...
          <p className="mt-6 max-w-2xl text-base text-white/70">
            Identifiez vos moteurs de motivation profonds pour aligner votre carrière.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            ...
            <Link
              ...
              className="rounded-full border border-white/20 bg-white/5 px-6 py-3 text-sm font-semibold text-white/80"
            >
