...
export default async function ResourcePaymentPage({ params }: PageProps) {
  ...
  // Si déjà acheté, gratuit, ou si c'est le créateur, rediriger vers la ressource
  if (isCreator || catalogItem.is_free || catalogItem.access_status === "purchased" || catalogItem.access_status === "manually_granted") {
    ...
    redirect(`/dashboard/catalogue/ressource/${id}`);
  }
