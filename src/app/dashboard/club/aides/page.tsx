  ...
  return (
    <ClubLayout activeItem="Aides & Formation">
      <div className="p-4 lg:p-8 pt-6 lg:pt-8 space-y-10">
        <div className="mb-8 rounded-2xl border border-[#8B1A2B]/30 bg-gradient-to-br from-[#1a2942] to-[#0d1b2e] p-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <button
              ...
              className="whitespace-nowrap rounded-xl bg-[#8B1A2B] px-6 py-3 font-semibold text-white transition-all hover:bg-[#5C1018]"
            >
              Commencer l&apos;audit →
            </button>
          </div>
          ...
          {auditCompleted && auditResults ? (
            <div className="mt-4 grid grid-cols-1 gap-3 border-t border-white/10 pt-4 sm:grid-cols-3">
              ...
              <div className="rounded-xl bg-white/5 p-3">
                ...
                <div className="text-sm font-semibold text-[#8B1A2B]">{auditResults.score}/100</div>
              </div>
            </div>
          ) : null}
        </div>
        <section className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-[#8B1A2B]/30 bg-gradient-to-br from-[#8B1A2B]/20 to-[#5C1018]/10 p-6">
            <div className="flex items-center gap-2">
              <Medal className="h-5 w-5 text-[#8B1A2B]" />
              <span className="rounded-full bg-[#8B1A2B]/20 px-3 py-1 text-xs text-[#8B1A2B]">Open Badges</span>
            </div>
            ...
            <div className="mt-3 text-xl font-black text-[#8B1A2B] lg:text-3xl">Jusqu'à 100% financé</div>
            ...
            <button className="mt-3 text-sm text-[#8B1A2B] underline">Voir les parcours Beyond →</button>
          </div>
        </section>
            ...
            <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
              <div className="h-[260px] min-h-[260px] rounded-xl bg-white/5 p-4">
                <ResponsiveContainer width="100%" height="100%">
                  <RadarChart data={radarData}>
                    ...
                    <Radar dataKey="value" stroke="#8B1A2B" fill="#8B1A2B" fillOpacity={0.3} />
                  </RadarChart>
                </ResponsiveContainer>
              </div>
              <div className="space-y-3">
                <div className="rounded-xl bg-white/5 p-4">
                  ...
                  <div className="text-sm font-semibold text-white">{auditResults.priorite1}</div>
                  <button className="mt-3 rounded-full bg-[#8B1A2B] px-4 py-2 text-xs font-semibold text-white">
                    En savoir plus
                  </button>
                </div>
                <div className="rounded-xl bg-white/5 p-4">
        ...
        <section className="grid grid-cols-2 gap-4">
          ...
          <div className="rounded-2xl border border-[#8B1A2B]/30 bg-gradient-to-br from-[#8B1A2B]/20 to-[#5C1018]/10 p-6">
            ...
            <div className="text-sm font-bold uppercase tracking-wider text-[#8B1A2B]">Développement des revenus</div>
            <div className="mt-2 flex flex-wrap gap-2 text-sm text-white">
              {[
                ...
                <button
                  key={item}
                  className="rounded-full bg-white/10 px-3 py-1 text-sm text-white hover:bg-[#8B1A2B]/30"
                >
                  {item}
                </button>
              ))}
            </div>
            <div className="mt-4 text-sm font-bold uppercase tracking-wider text-[#8B1A2B]">
            ...
            <a
              ...
              className="mt-4 inline-flex rounded-full bg-[#8B1A2B] px-5 py-2 text-sm font-semibold text-white"
            >
        ...
        <section className="rounded-2xl bg-gradient-to-r from-[#8B1A2B] to-[#5C1018] p-4 lg:p-8">
          ...
          <a
            ...
            className="mt-6 inline-flex rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#5C1018]"
          >
      ...
      {showAudit && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-white/10 bg-[#0d1b2e]">
            ...
            <div className="p-6">
              <div className="mb-2">
                <span className="text-xs font-medium uppercase tracking-wider text-[#8B1A2B]">
                  ...
                  <button
                    ...
                    className={`w-full rounded-xl border p-4 text-left transition-all ${
                      answers[currentQuestion] === option.value
                        ? "border-[#8B1A2B] bg-[#8B1A2B]/10 text-white"
              ...
              <div className="mt-8 flex justify-between">
                ...
                {currentQuestion < AUDIT_QUESTIONS.length - 1 ? (
                  <button
                    ...
                    className="rounded-xl bg-[#8B1A2B] px-6 py-2 font-semibold text-white transition-all disabled:opacity-40"
                  >
                    Suivant →
                  </button>
                ) : (
