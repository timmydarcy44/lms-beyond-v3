    ...
    const load = async () => {
      ...
      if (roleValue === "demo") {
        ...
        setFormData({
          ...
          resultat_n1: "15000",
          nom_officiel: "Football Club Rochelais",
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <div className="mt-3 h-3 w-full rounded-full bg-white/10">
                <div
                  className="h-3 rounded-full bg-gradient-to-r from-[#8B1A2B] to-orange-500"
            ...
            <button
              onClick={handleSave}
              className="rounded-full bg-[#8B1A2B] px-6 py-2.5 text-sm font-semibold text-white"
            >
              Sauvegarder
            </button>
          </div>
