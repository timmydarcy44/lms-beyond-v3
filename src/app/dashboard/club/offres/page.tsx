      ...
      <div className="mt-10">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              className="rounded-full bg-[#8B1A2B] px-6 py-3 text-base font-semibold text-white"
      ...
      <Dialog open={showAddPrestationDialog} onOpenChange={setShowAddPrestationDialog}>
        <DialogContent className="bg-[#1B2A4A] text-white">
          ...
          <DialogFooter>
            ...
            <button
              className="rounded-full bg-[#8B1A2B] px-4 py-2 text-sm font-semibold text-white"
