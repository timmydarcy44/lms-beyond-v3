...
const statusStyles: Record<string, string> = {
  "Signé": "bg-[#8B1A2B]/20 text-[#8B1A2B] border border-[#8B1A2B]/30",
            ...
            <div className="mt-6 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              {partners.map((partner) => (
                <div
                  ...
                  className="rounded-2xl border border-white/20 bg-white/10 p-5 shadow-lg backdrop-blur-md transition-all duration-200 hover:border-[#8B1A2B]/40 hover:bg-white/20"
                >
