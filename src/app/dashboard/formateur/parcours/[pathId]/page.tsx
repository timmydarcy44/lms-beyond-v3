    ...
    >
      <div className="space-y-10">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
          ...
          >
            <Link href={`/dashboard/formateur/parcours/${path.id}/edit`}>Modifier le parcours</Link>
          </Button>
          <Button
            asChild
            ...
            variant="ghost"
          >
            <Link href={`/dashboard/formateur/parcours/${path.id}/scenarios`}>Configurer des scénarios</Link>
          </Button>
        </div>
      </div>
    </DashboardShell>
