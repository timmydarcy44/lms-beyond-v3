...
const posts = [
  ...
  },
  {
    ...
    text:
      "Nous sommes fiers d'accueillir Normandie Énergie dans la famille Football Club Rochelais. Un partenariat fort pour la saison 2025/2026.",
...
const categoryStyles: Record<string, string> = {
  ...
  Partenariat: "bg-[#8B1A2B]/20 text-[#8B1A2B]",
            ...
            >
              <div className="flex items-center gap-3 p-4">
                {partenaireClub.logoUrl ? (
                  ...
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#8B1A2B] text-xs font-bold text-white">
              ...
              <div className="p-4">
                ...
                {post.cta && (
                  <button className="mt-3 rounded-full bg-[#8B1A2B] px-4 py-1.5 text-xs font-semibold text-white">
                    {post.cta}
                  </button>
                )}
              </div>
            ...
            <div className="sticky top-6 space-y-4">
              ...
              <div className="rounded-2xl border border-white/10 bg-[#111827] p-4">
                ...
                <div className="mt-2 h-1.5 rounded-full bg-white/10">
                  <div className="h-1.5 w-[65%] rounded-full bg-[#8B1A2B]" />
                </div>
                <div className="mt-2 text-xs text-white/50">65% de la saison écoulée</div>
                <div className="mt-4 rounded-xl bg-[#8B1A2B]/10 p-3 text-xs text-white/70">
