    ...
    <div className="min-h-screen bg-[#fbfbff] text-gray-900">
      ...
      <main className="relative mx-auto max-w-5xl px-6 py-10 pb-40 pl-[268px]">
        <header className="mb-8">
          ...
          <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-gray-950">Mes Formations</h1>
          <p className="mt-2 text-sm text-gray-600">À venir — cette section affichera vos parcours et ressources.</p>
        </header>
      </main>
    </div>
  );
