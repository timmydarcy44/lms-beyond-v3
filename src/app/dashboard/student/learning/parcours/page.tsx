...
import { LearnerParcoursPageImpl, type FeaturedParcoursHero } from "./learner-parcours-page-impl";
...
export default async function LearnerParcoursIndexPage() {
  ...
  return <LearnerParcoursPageImpl data={{ ...data, parcours }} featuredHero={featuredHero} />;
}
