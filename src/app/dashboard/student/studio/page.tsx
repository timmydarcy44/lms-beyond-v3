...
export default async function FormateurDashboardPage() {
  ...
  const quickItems = [
    {
      ...
      href: "/dashboard/student/studio/formations/new",
    },
    {
      key: "build-path",
      ...
      href: "/dashboard/student/studio/parcours",
    },
    {
      key: "create-test",
      ...
      cta: "Créer",
      image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=900&q=80",
      href: "/dashboard/student/studio/tests/new",
    },
    {
      key: "share-resource",
      ...
      href: "/dashboard/student/studio/ressources",
    },
  ];
  ...
  return (
    ...
    >
      <TasksBanner roleFilter="instructor" todoHref="/dashboard/student/studio/todo" />
