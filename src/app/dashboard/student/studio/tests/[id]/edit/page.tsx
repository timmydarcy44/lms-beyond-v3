...
export default function FormateurTestEditPage() {
  ...
  useEffect(() => {
    if (testId && testId !== 'new') {
      ...
      router.replace(`/dashboard/student/studio/tests/new?testId=${testId}`);
    } else {
      router.replace('/dashboard/student/studio/tests');
    }
  }, [testId, router]);
  ...
  return (
    <DashboardShell
      ...
      breadcrumbs={[
        ...
        { label: "Tests", href: "/dashboard/student/studio/tests" },
        { label: "Édition" },
      ]}
    >
