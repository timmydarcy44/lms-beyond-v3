...
import { JessicaMailsClient } from "@/components/jessica-contentin/jessica-mails-client";

export const revalidate = 0;

export default async function JessicaMailsPage() {
  ...
  return <JessicaMailsClient contacts={mailContacts} />;
}
