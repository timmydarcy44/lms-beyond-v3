...
export default async function SuperAdminNewFormationStructurePage() {
    ...
    <main className="mx-auto max-w-7xl px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-sm" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", system-ui, sans-serif' }}>
          Construisez la structure de votre formation avec sections, chapitres et sous-chapitres
        </p>
      </div>
      <CourseBuilderWorkspace previewHref="/super/studio/formations/new/preview" />
    </main>
  );
}
