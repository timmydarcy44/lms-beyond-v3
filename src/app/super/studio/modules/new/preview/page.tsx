...
export default function SuperAdminNewModulePreviewPage() {
    ...
    <main className="mx-auto max-w-7xl px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-sm" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", system-ui, sans-serif' }}>
          Visualisez votre module tel qu&apos;il apparaîtra aux apprenants
        </p>
      </div>
      <div className="space-y-6">
        ...
        >
          <Link href="/super/studio/modules/new/structure">Revenir au builder</Link>
        </Button>
