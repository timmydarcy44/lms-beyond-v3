...
import { TestCreateFormSuperAdmin } from "@/components/super-admin/test-create-form-super-admin";

export const dynamic = 'force-dynamic';
export const revalidate = 0;

export default async function SuperAdminNewTestPage() {
    ...
    <main className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-sm" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", system-ui, sans-serif' }}>
            Configurez votre test et évaluations
          </p>
        </div>
        <TestCreateFormSuperAdmin />
    </main>
  );
}
