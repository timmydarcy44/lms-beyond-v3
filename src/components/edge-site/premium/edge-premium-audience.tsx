  ...
  const cards = [
    {
      title: "Business",
      description:
        "Formez vos équipes, développez les compétences et pilotez la performance.",
      cta: "Découvrir l'univers business",
      href: links.business,
      image: EDGE_PREMIUM_IMAGES.business,
      alt: "Dirigeant ou manager en entreprise",
      icon: Briefcase,
      gradient: "from-[#111111]/80 via-[#080808]/90 to-[#050505]",
    },
    {
      title: "Particulier",
      description:
        "Développez vos compétences et valorisez votre parcours professionnel.",
      cta: "Découvrir l'univers particulier",
      href: links.particulier,
      image: EDGE_PREMIUM_IMAGES.former,
      alt: "Professionnel en développement de compétences",
      icon: UserRound,
      gradient: "from-[#111111]/80 via-[#080808]/90 to-[#050505]",
    },
  ] as const;
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-2">
          {cards.map((card) => (
            <article
              key={card.title}
              className="group relative isolate min-h-[360px] overflow-hidden rounded-[28px] border border-white/[0.07] transition-[border-color,box-shadow] duration-300 hover:border-white/[0.14] hover:shadow-[0_16px_48px_rgba(0,0,0,0.35)] sm:min-h-[400px]"
            >
