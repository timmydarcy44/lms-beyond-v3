...
export function JessicaHeroTrustBadges() {
  return (
    <section className="border-b border-[#E6D9C6]/70 bg-[#FFFCF9]" aria-label="Informations pratiques">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-5 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-x-8 sm:gap-y-3 md:px-8 md:py-6">
        {BADGES.map((label) => (
