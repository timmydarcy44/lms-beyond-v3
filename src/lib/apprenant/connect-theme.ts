...
const EDGE_THEME: ConnectShellTheme = {
  ...
  sidebarClass:
    "no-dyslexia sticky left-0 top-0 z-20 hidden h-screen shrink-0 flex-col border-r border-white/[0.03] bg-transparent backdrop-blur-[20px] backdrop-saturate-[140%] lg:flex",
  sidebarHeaderBorder: "border-b border-white/[0.03]",
  sidebarFooterClass: "shrink-0 space-y-2 border-t border-white/[0.03] p-2",
  collapseBtnClass:
    "ml-auto inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/[0.05] bg-white/[0.03] text-white/70 transition hover:border-[#3D7BFF]/35 hover:bg-[#3D7BFF]/10 hover:text-white",
  navActiveClass: "bg-[rgba(61,123,255,0.12)] text-white",
  navActiveCollapsedClass: "bg-[rgba(61,123,255,0.12)] text-white ring-1 ring-[rgba(61,123,255,0.2)]",
  navInactiveClass: "text-white/45 hover:bg-white/[0.03] hover:text-white",
  navIconActive: "text-[#3D7BFF]",
  navIconInactive: "text-white/45 group-hover:text-white/70",
  profileBorder: "border-[rgba(61,123,255,0.28)]",
  profileInitialClass: "text-xs font-semibold text-[#3D7BFF]",
  profileAvatarBg: "bg-[#111118]/60",
  profileNameClass: "truncate text-xs font-semibold text-white",
  profileRoleClass: "truncate text-[10px] text-white/45",
  profileEditBtnClass:
    "mt-2 w-full rounded-full border border-white/15 bg-transparent py-2 text-[11px] font-medium text-white/70 transition hover:border-white/25",
  profileCollapsedBtnClass:
    "mx-auto flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.05] bg-white/[0.03] text-xs font-semibold text-[#3D7BFF] transition hover:border-[#3D7BFF]/40",
  helpLinkClass:
    "flex w-full items-center justify-center gap-2 rounded-xl border border-white/[0.04] bg-transparent py-2 text-[11px] font-medium text-white/45 transition hover:bg-white/[0.03] hover:text-white/70",
  neuroBtnClass:
    "flex w-full items-center justify-center gap-2 rounded-xl border border-white/[0.04] bg-transparent py-2 text-[11px] font-medium text-white/55 transition hover:border-white/10 hover:bg-white/[0.03] hover:text-white/85",
  logoutBtnClass:
    "flex w-full items-center justify-center rounded-xl py-2 text-[11px] font-medium text-white/25 transition hover:bg-white/[0.03] hover:text-white/40",
  mainClass: "relative flex-1 min-w-0 overflow-x-hidden overflow-y-auto bg-transparent text-slate-100",
  mobileHeaderClass: "sticky top-0 z-30 border-b border-white/[0.04] bg-[#0a0a0d]/55 px-4 py-3 backdrop-blur-md lg:hidden",
  mobileTitleClass: "truncate text-center text-sm font-semibold text-white",
  mobileMenuBtnClass:
    "inline-flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.04] text-slate-200",
  mobileSheetClass: "border-white/[0.06] bg-[#0a0a0d]/92 text-slate-100 backdrop-blur-xl",
  mobileNavActive: "bg-[#3D7BFF]/12 text-white ring-1 ring-[#3D7BFF]/25",
  mobileNavInactive: "text-slate-400 hover:bg-white/[0.03] hover:text-white",
  mobileNavIconActive: "text-[#3D7BFF]",
  mobileNavIconInactive: "text-slate-500 group-hover:text-slate-300",
  shareToastClass: "max-w-md rounded-2xl border border-white/[0.06] bg-[#0a0a0d]/95 px-6 py-5 text-center shadow-2xl shadow-black/40",
  shareToastBtnClass:
