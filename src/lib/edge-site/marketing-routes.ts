...
export const EDGE_MARKETING_PATHS = {
  ...
  particulierCertifications: "/certifications",
  particulierIA: "/online/formations",
  particulierManagement: "/business/catalogue",
  particulierVente: "/business/former-vos-equipes",
  particulierRh: "/business/former-vos-equipes",
  particulierSoftSkills: "/particuliers/soft-skills",
  particulierDevelopper: "/online",
  particulierEdgeOnline: "/online",
  particulierMicroCertifications: "/certifications",
  particulierOpenBadges: "/business/open-badges",
  particulierCpf: "/financement",
  particulierFranceTravail: "/financement",
  particulierOpco: "/financement",
  particulierFinancementPerso: "/financement",
  particulierReconversion: "/particuliers/carriere",
  particulierCoaching: "/contact",
  particulierAccompagnement: "/contact",
  formationsSpecialites: "/formations",
  formationsTitresPro: "/formations/bts",
} as const;
