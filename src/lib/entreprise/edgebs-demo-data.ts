...
export const EDGEBS_DEMO_METIERS = [
  {
    ...
    soft_skills: ["Assertivité::85", "Écoute::80", "Résilience::82", "Influence::78", "Organisation::75"],
  },
  {
    id: "edgebs-metier-rh",
    ...
    soft_skills: ["Empathie::88", "Discernement::82", "Communication::85", "Organisation::80", "Confidentialité::90"],
  },
  {
    ...
    soft_skills: ["Leadership::88", "Feedback::85", "Coopération::80", "Gestion du stress::78", "Décision::82"],
  },
  {
    ...
    soft_skills: ["Pédagogie::90", "Créativité::78", "Transmission::85", "Écoute::82", "Organisation::76"],
  },
  {
    ...
    soft_skills: ["Rigueur::86", "Adaptabilité::78", "Communication::80", "Organisation::88", "Gestion du stress::74"],
  },
  {
    ...
    soft_skills: ["Storytelling::84", "Créativité::86", "Curiosité::80", "Collaboration::78", "Communication::82"],
  },
] as const;
