...
export const SPECIALITY_SEO_CONFIG: Record<string, {
  ...
  "confiance-en-soi": {
    title: "Confiance en soi & estime de soi — Accompagnement Caen",
    description: "Accompagnement pour renforcer la confiance en soi et l'estime de soi à Caen. Compréhension de soi, affirmation, régulation émotionnelle et autonomie. Cabinet Bretteville-sur-Odon.",
    h1: "Renforcer la confiance en soi et l'estime de soi",
    keywords: [
  ...
  "regulation-emotionnelle": {
    title: "Régulation émotionnelle — Accompagnement adultes Caen",
    description: "Accompagnement pour mieux comprendre et réguler ses émotions, apaiser le stress et retrouver un équilibre au quotidien. Psychopédagogue à Bretteville-sur-Odon.",
    h1: "Régulation émotionnelle",
    keywords: [
      "régulation émotionnelle Caen",
      "gestion des émotions Caen",
      "hypersensibilité émotionnelle",
      "stress adulte Caen",
      "psychopédagogue émotions",
    ],
    contentSections: [
      {
        title: "Pour qui ?",
        content: "Cet accompagnement s'adresse aux adultes qui ressentent :<br/><br/>• une hypersensibilité émotionnelle ;<br/>• des réactions émotionnelles intenses ou difficiles à maîtriser ;<br/>• une tendance aux ruminations ;<br/>• un stress récurrent ou une surcharge mentale importante ;<br/>• des difficultés à gérer certaines situations relationnelles ;<br/>• une anxiété persistante ;<br/>• des difficultés à poser leurs limites ;<br/>• un manque de confiance en eux ;<br/>• un sentiment d'épuisement émotionnel ;<br/>• une impression d'être facilement submergés par leurs émotions.",
        keywords: ["adultes", "hypersensibilité", "stress"],
      },
      {
        title: "Mon approche",
        content: "L'accompagnement vise à développer une meilleure compréhension de son fonctionnement émotionnel afin d'apprendre à identifier, accueillir et réguler ses émotions de manière plus adaptée. Les séances permettent d'explorer les mécanismes à l'origine des réactions émotionnelles, de renforcer les capacités d'autorégulation et de construire des stratégies concrètes favorisant un équilibre plus durable au quotidien.\n\nCette approche s'appuie sur les connaissances issues de la neuroéducation, des sciences cognitives et de la psychologie, tout en tenant compte de l'histoire, du fonctionnement et des objectifs propres à chaque personne.",
        keywords: ["approche", "neuroéducation", "autorégulation"],
      },
      {
        title: "Ce que nous travaillons ensemble",
        content: "Selon vos besoins, l'accompagnement peut permettre de :<br/><br/>• mieux comprendre vos réactions émotionnelles ;<br/>• identifier les situations qui déclenchent du stress, de l'anxiété ou de la frustration ;<br/>• repérer les schémas de pensée qui entretiennent certaines difficultés ;<br/>• développer des outils de régulation émotionnelle ;<br/>• mieux gérer les situations de conflit ou de tension ;<br/>• renforcer l'affirmation de soi ;<br/>• apprendre à poser des limites de manière adaptée ;<br/>• diminuer l'impact des ruminations ;<br/>• retrouver davantage de confiance dans vos capacités ;<br/>• développer une meilleure connaissance de vous-même.",
        keywords: ["stratégies", "affirmation de soi", "ruminations"],
      },
      {
        title: "Les objectifs de l'accompagnement",
        content: "L'accompagnement a pour objectif de vous aider à mieux comprendre votre fonctionnement émotionnel afin de développer des réponses plus adaptées aux situations que vous rencontrez.\n\nAu fil des séances, vous pourrez notamment :<br/><br/>• identifier plus facilement vos émotions et leurs déclencheurs ;<br/>• prendre davantage de recul face aux situations difficiles ;<br/>• développer des stratégies de régulation adaptées à votre fonctionnement ;<br/>• mieux gérer votre stress et votre charge mentale ;<br/>• renforcer votre confiance en vous ;<br/>• améliorer vos relations personnelles et professionnelles ;<br/>• retrouver un sentiment de stabilité et de sécurité intérieure.",
        keywords: ["objectifs", "confiance", "équilibre"],
      },
      {
        title: "Déroulement des séances",
        content: "Chaque accompagnement débute par un temps d'échange permettant de comprendre votre situation, vos difficultés actuelles et vos objectifs.\n\nLes séances s'appuient ensuite sur des situations concrètes de votre quotidien afin d'identifier les mécanismes en jeu, de mieux comprendre votre fonctionnement et de construire progressivement des outils adaptés à vos besoins.\n\nLe rythme et la durée de l'accompagnement sont définis en fonction de votre situation et de vos objectifs.",
        keywords: ["séances", "individualisé"],
      },
      {
        title: "Une approche personnalisée",
        content: "Chaque personne possède une histoire, un vécu et un fonctionnement émotionnel qui lui sont propres. L'accompagnement est donc entièrement individualisé et vise à proposer des outils réalistes, applicables et adaptés à votre quotidien.\n\nL'objectif est de vous permettre de mieux comprendre ce qui se joue dans certaines situations afin de développer progressivement des stratégies favorisant un équilibre émotionnel plus stable et durable.",
        keywords: ["personnalisé", "équilibre émotionnel"],
      },
    ],
  },
  "gestion-stress": {
  ...
  "methodologie-de-travail": {
    title: "Méthodologie de travail — Accompagnement Caen",
    description: "Développer une méthodologie de travail fondée sur son fonctionnement cognitif. Organisation, mémorisation, attention et autonomie. Psychopédagogue à Caen.",
    h1: "Méthodologie de travail",
    keywords: ["méthodologie de travail Caen", "méthode de travail", "organisation scolaire", "psychopédagogue méthode"],
    contentSections: [],
  },
  college: {
    title: "Accompagnement collège — Méthode & confiance Caen",
    description: "Accompagnement des collégiens : méthode de travail, organisation, attention, motivation et confiance. Cabinet Jessica Contentin près de Caen.",
    h1: "Collège",
    keywords: ["accompagnement collège Caen", "méthode collège", "brevet", "psychopédagogue collège"],
    contentSections: [],
  },
  lycee: {
    title: "Accompagnement lycée — Méthode & bac Caen",
    description: "Accompagnement des lycéens : méthodologie, organisation, stress, baccalauréat et orientation. Psychopédagogue à Bretteville-sur-Odon.",
    h1: "Lycée",
    keywords: ["accompagnement lycée Caen", "méthode lycée", "baccalauréat", "psychopédagogue lycée"],
    contentSections: [],
  },
  "etudes-superieures": {
    title: "Études supérieures — Stratégies d'apprentissage Caen",
    description: "Accompagnement des étudiants : organisation, mémorisation, examens, concours et prévention de l'épuisement. Psychopédagogue près de Caen.",
    h1: "Études supérieures",
    keywords: ["études supérieures Caen", "méthode universitaire", "préparation examens", "psychopédagogue étudiant"],
    contentSections: [],
  },
  tdah: {
    title: "Accompagnement TDAH — Stratégies adaptées Caen",
    description: "Accompagnement TDAH : attention, organisation, fonctions exécutives et autonomie. Stratégies concrètes pour le quotidien scolaire et professionnel.",
    h1: "TDAH",
    keywords: ["accompagnement TDAH Caen", "TDAH stratégies", "fonctions exécutives", "psychopédagogue TDAH"],
    contentSections: [],
  },
  "troubles-dys": {
    title: "Troubles DYS — Stratégies d'apprentissage Caen",
    description: "Accompagnement des troubles DYS (dyslexie, dysorthographie, dyscalculie, dysgraphie, dyspraxie). Stratégies compensatoires individualisées.",
    h1: "Troubles DYS",
    keywords: ["troubles DYS Caen", "dyslexie Caen", "dyscalculie", "psychopédagogue DYS"],
    contentSections: [],
  },
  tsa: {
    title: "Accompagnement TSA — Autisme & apprentissages Caen",
    description: "Accompagnement TSA : fonctionnement autistique, apprentissages, autonomie et guidance parentale. Approche individualisée près de Caen.",
    h1: "TSA",
    keywords: ["accompagnement TSA Caen", "autisme apprentissages", "guidance parentale TSA", "psychopédagogue TSA"],
    contentSections: [],
  },
  "haut-potentiel": {
    title: "Haut potentiel intellectuel (HPI) — Accompagnement Caen",
    description: "Accompagnement HPI : comprendre un fonctionnement cognitif singulier, prévenir le décrochage et développer une méthodologie adaptée.",
    h1: "Haut potentiel intellectuel (HPI)",
    keywords: ["haut potentiel Caen", "HPI Caen", "accompagnement HPI", "psychopédagogue haut potentiel"],
    contentSections: [],
  },
};
