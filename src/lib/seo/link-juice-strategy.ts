...
export const SPECIALITY_SEO_CONFIG: Record<string, {
  ...
  "regulation-emotionnelle": {
    title: "Régulation émotionnelle & gestion du stress — Accompagnement Caen",
    ...
    keywords: [
      ...
      "gestion du stress Caen",
      "anxiété Caen",
      "psychopédagogue émotions",
    ],
    contentSections: [
      {
        title: "Un accompagnement centré sur la compréhension émotionnelle",
        content: "Les émotions et le stress influencent notre quotidien, nos relations, nos apprentissages et notre bien-être. Mon accompagnement vise à mieux comprendre ces mécanismes afin de développer des stratégies de régulation adaptées à votre fonctionnement.\n\nChaque personne réagit différemment face aux situations de tension, d'anxiété ou de surcharge. L'objectif est d'identifier vos ressources, vos fragilités et les leviers les plus efficaces pour retrouver davantage de sérénité.",
        keywords: ["régulation émotionnelle", "stress", "émotions"],
      },
      {
        title: "Ce que nous travaillons ensemble",
        content: "<strong>Comprendre ses réactions émotionnelles</strong> — Identifier les déclencheurs, les pensées et les comportements associés.<br/><br/><strong>Développer des stratégies de régulation</strong> — Mettre en place des outils concrets pour apaiser le stress et mieux gérer les émotions.<br/><br/><strong>Retrouver un équilibre durable</strong> — Installer des habitudes et des repères favorisant le bien-être au quotidien.",
        keywords: ["stratégies", "équilibre", "bien-être"],
      },
    ],
  },
  "gestion-stress": {
