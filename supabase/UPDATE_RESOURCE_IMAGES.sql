...
UPDATE resources
SET 
  thumbnail_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Sommeil.png',
  cover_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Sommeil.png'
...
UPDATE resources
SET 
  thumbnail_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Gestion_Colere.png',
  cover_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Gestion_Colere.png'
...
BEGIN
  ...
  UPDATE tests
  SET 
    thumbnail_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Confiance_en_soi_test.png',
    cover_image = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Confiance_en_soi_test.png'
  ...
  IF EXISTS (
    ...
    UPDATE tests
    SET hero_image_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Confiance_en_soi_test.png'
    WHERE title ILIKE '%confiance en soi%'
      OR slug = 'test-confiance-en-soi';
  END IF;
END $$;
...
SET 
  thumbnail_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Confiance_en_soi_test.png',
  hero_image_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Confiance_en_soi_test.png'
...
SET 
  thumbnail_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Sommeil.png',
  hero_image_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Sommeil.png'
...
SET 
  thumbnail_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Gestion_Colere.png',
  hero_image_url = 'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/Jessica%20CONTENTIN/Guide_Gestion_Colere.png'
WHERE item_type = 'ressource'
  AND content_id IN (
    SELECT id FROM resources 
    WHERE (title ILIKE '%colère%' AND title ILIKE '%5 étapes%')
