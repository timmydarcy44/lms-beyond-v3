...
SET public_url = REPLACE(
  ...
  'zmcefidiiqqppowymoxt'  -- Remplacez par votre vrai project ID
)
...
-- Remplacez zmcefidiiqqppowymoxt par votre vrai project ID
UPDATE gamification_videos
SET public_url = CONCAT(
  'https://zmcefidiiqqppowymoxt.supabase.co/storage/v1/object/public/',
  storage_bucket,
  '/',
